...
def index(request):
    ...
    query = {'dt_liberacao_ini': request.GET.get('dt_liberacao_ini'),
...
def add(request):
    if request.method == "GET":
        ...
        itens = {'nr_cheque': request.POST.get('nr_cheque'),
...
def addcadastro(request):
    if request.method == "GET":
        ...
        itens = {'nome': request.POST.get('nome'),
...
def chequesdel(request, id = None):
    if request.method == "GET":
        ...
        hist = {'nr_cheque': instance.nr_cheque,
